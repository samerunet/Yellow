			...
			<div>
				<header className='shadow-sm thenav'>
					<div className='flex items-center justify-between h-16 px-4 mx-auto max-w-screen-xl'>
						...
						<nav className='items-center justify-center hidden text-sm font-medium space-x-8 lg:flex lg:flex-1 lg:w-0'>
							<Link
								to={`/`}
						...
						<div className='items-center hidden space-x-4 lg:flex'>
							<p
								className='cursor-pointer px-5 py-2 text-sm font-medium text-gray-600  rounded-lg '
								href='#'
							>
								<svg
									className='w-6 h-6'
							...
							<Link
								to={`/login`}
								className='px-5 py-2 text-sm font-medium text-white bg-lime-500 rounded-lg'
								href=''
							>
								Log out
							</Link>
