		...
		<div className='w-64 max-h-full h-screen bg-white rounded-lg border border-gray-200 shadow-md dark:bg-white right-bar'>
			...
			<div className='flex flex-col items-center pb-10  md:mt-10'>
				...
				<div className='flex mt-4 space-x-3 md:mt-6'>
					<div className='inline-block items-center py-2 px-4 text-sm font-medium text-center text-gray-900  rounded-lg  focus:ring-4 focus:outline-none   dark:text-white  dark:focus:ring-gray-700'>
						<h2 className='text-yellow-300'>11K</h2>
						<h5 className='text-black dark:hover:text-yellow-300 cursor-pointer'>Followers</h5>
					</div>
					<div className='inline-block items-center py-2 px-4 text-sm font-medium text-center text-gray-900  rounded-lg  focus:ring-4 focus:outline-none   dark:text-white  dark:focus:ring-gray-700'>
						<h3 className='text-yellow-300'>1.4K</h3>
						<h5 className='text-black dark:hover:text-yellow-300 cursor-pointer'>Following</h5>
					</div>
				</div>
				...
				<div className='flex mt-4 space-x-3 md:mt-6'>
					...
					<h5 className='dark:hover:text-yellow-300 cursor-pointer'>Request</h5>
				</div>
				<div className='flex mt-4 space-x-3 md:mt-12'>
					<div className='inline-block'>
						<h5 className='dark:hover:text-yellow-300 cursor-pointer'>Settings and Privacy</h5>
					</div>
				</div>
				<div className='flex mt-4 space-x-3 md:mt-6'>
					<div className='inline-block'>
						<h5 className='dark:hover:text-yellow-300 cursor-pointer'>Help Center</h5>
					</div>
				</div>
			</div>
		</div>
